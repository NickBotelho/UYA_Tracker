...
function DetailedGame(props){
    ...
    if (game['gamemode']=="CTF"){
        winners = populateCTFRow(game['game_results']['winners'], cellWidth, setWeaponBreakdown, game['weapons'], setSearchName, isDesktop)
        losers = populateCTFRow(game['game_results']['losers'], cellWidth, setWeaponBreakdown , game['weapons'], setSearchName, isDesktop)
        disconnects = 'disconnect' in game['game_results'] ? populateCTFRow(game['game_results']['disconnect'], cellWidth, setWeaponBreakdown , game['weapons'], setSearchName, isDesktop) : null
        mode = 5
        if (winners.length == 1 && losers.length == 1){
            tie = populateCTFRow(game['game_results']['tie'], cellWidth, setWeaponBreakdown , game['weapons'], setSearchName, isDesktop)
        }
    }
    else if (game['gamemode'] == 'Siege'){
        winners = populateSiegeRow(game['game_results']['winners'], cellWidth, setWeaponBreakdown , game['weapons'], setSearchName, isDesktop)
        losers = populateSiegeRow(game['game_results']['losers'], cellWidth, setWeaponBreakdown , game['weapons'], setSearchName, isDesktop)
        disconnects = 'disconnect' in game['game_results'] ? populateSiegeRow(game['game_results']['disconnect'], cellWidth, setWeaponBreakdown , game['weapons'], setSearchName, isDesktop) : null
        mode = 5
    }
    else{
        winners = populateDMRow(game['game_results']['winners'], cellWidth, setWeaponBreakdown , game['weapons'], setSearchName, isDesktop)
        losers = populateDMRow(game['game_results']['losers'], cellWidth, setWeaponBreakdown , game['weapons'], setSearchName, isDesktop)
        disconnects = 'disconnect' in game['game_results'] ? populateDMRow(game['game_results']['disconnect'], cellWidth, setWeaponBreakdown , game['weapons'], setSearchName, isDesktop) : null
